<?php
    ...
    class FrontendRoomController extends Controller
    {
        ...
        public function RoomDetailsPage($id)
        {
            ...
            return view('frontend.room.room_details', compact('roomdetails', 'multiImage', 'facilities', 'otherRooms'));
        }  // End Method
        ...
        public function BookingSearch(Request $request)
        {
            ...
            foreach ($d_period as $period) {
                array_push($dt_array,
                    date('Y-m-d', strtotime($period)));
            }

            $check_date_booking_ids = RoomBookedDate::whereIn('book_date', $dt_array)->distinct()->pluck('booking_id')
                ->toArray();
        ...
        public function SearchRoomDetails(Request $request, $id)
        {
            ...
            $otherRooms = Room::where('id', '!=', $id)->orderBy('id', 'DESC')->Limit(2)->get();
            $room_id = $id;
            return view('frontend.room.search_room_details', compact('roomdetails', 'multiimg', 'facilities', 'otherRooms', 'room_id'));
